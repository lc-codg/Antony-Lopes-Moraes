        ...
        <div class="tab-content">
            ...
            <div id="Dados Pessoais" class="tab-pane active .container-fluid">
                ...
                <div Style='margin-left:1%;margin-right:1%;'class='form-row'>
                    ...
                    <div class="form-group col-md-2">
                        <label for="">CPF</label>
                        <input required type="number"Value="{{$cliente->Cpf}}" class="form-control" name="CPF" id="" aria-describedby="helpId" placeholder="">
                    </div>
            ...
            <div id="Dados Empresarias" class="tab-pane .container-fluid">
                ...
                <div Style='margin-left:1%;margin-right:1%;'class='form-row'>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input Value="{{$cliente->Fantasia}}"type="text" class="form-control" name="fantasia" id="" aria-describedby="helpId" placeholder="">
                    </div>

                    <div class="form-group col-md-2">
                        <label for="">CNPJ</label>
                        <input  Value="{{$cliente->Cnpj}}"type="number" class="form-control" name="cnpj" id="" aria-describedby="helpId" placeholder="">
                    </div>

                    <div class="form-group col-md-2">
                        <label for="">Inscrição Estadual</label>
                        <input Value="{{$cliente->Ie}}" type="number" class="form-control" name="ie" id="" aria-describedby="helpId" placeholder="">
                    </div>
            ...
            <div id="Dados Financeiros" class="tab-pane .container-fluid">
                ...
                <div  class="form-group col-md-4">
                        ...
                        <input Value="{{$cliente->Tipo}}"type="text" class="form-control" name="tipo" id="" aria-describedby="helpId" placeholder="">
                    </div>
