...
<body>
    <div class='. container-fluid'>
            ...
            <div class="tab-content">
                ...
                <div id="Dados" class="tab-pane active .container-fluid">
                    ...
                    <div Style='margin-left:1%;margin-right:1%;' class='form-row'>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input required type="text" class="form-control" name="Barras" id="" aria-describedby="helpId" placeholder="">
                        </div>

                        <div class="form-group col-md-9">
                            <label for="">Descrição</label>
                            <input required type="text" class="form-control" name="Descricao" id="" aria-describedby="helpId" placeholder="">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="">Quantidade</label>
                            <input type="number" pattern="[0-9]+([,\.][0-9]+)?" value='1' min="0" step="any" class="form-control" name="Quantidade" id="" aria-describedby="helpId" placeholder="">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="">Peso</label>
                            <input type="number" pattern="[0-9]+([,\.][0-9]+)?" min="0" step="any" class="form-control" value='1' name="peso" id="" aria-describedby="helpId" placeholder="">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="">Preço de Venda</label>
                            <input required type="number" pattern="[0-9]+([,\.][0-9]+)?" onkeyup="Valores();" min="0" step="any" class="form-control" name="ValorUnitario" id="venda" aria-describedby="helpId" placeholder="">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="">Preço Promoção</label>
                            <input type="number" pattern="[0-9]+([,\.][0-9]+)?" value='1' min="0" step="any" class="form-control" name="promocao" id="promocao" aria-describedby="helpId" placeholder="">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="">Preço a Prazo</label>
                            <input type="number" pattern="[0-9]+([,\.][0-9]+)?" value='1' min="0" step="any" class="form-control" name="prazo" id="prazo" aria-describedby="helpId" placeholder="">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="">Preço de Custo</label>
                            <input type="number" pattern="[0-9]+([,\.][0-9]+)?" value='1' min="0" step="any" class="form-control" name="custo" id="custo" aria-describedby="helpId" placeholder="">
                        </div>
                ...
                <div id="Tributacao" class="tab-pane .container-fluid">
                    ...
                    <div Style='margin-left:1%; margin-right:1%;' class='form-row'>
                        ...
                        <div class="form-group col-md-2">
                            <label for="">Ncm</label>
                            <input type="text" class="form-control" name="ncm" id="" aria-describedby="helpId" placeholder="">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="">Cest</label>
                            <input type="text" class="form-control" name="cest" id="" aria-describedby="helpId" placeholder="">
                        </div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="numeric" class="form-control" name="cst" id="" aria-describedby="helpId" placeholder="">
                        </div>
                ...
                <div id="Outros" class="tab-pane .container-fluid">
                    ...
                    <div Style='margin-left:1%;margin-right:1%;' class='form-row'>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" class="form-control" name="tamanho" id="" aria-describedby="helpId" placeholder="">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="">Cor</label>
                            <input type="text" class="form-control" name="cor" id="" aria-describedby="helpId" placeholder="">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="">Referência</label>
                            <input type="text" class="form-control" name="referencia" id="" aria-describedby="helpId" placeholder="">
                        </div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" class="form-control" name="modelo" id="" aria-describedby="helpId" placeholder="">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="">Série</label>
                            <input type="text" class="form-control" name="serie" id="" aria-describedby="helpId" placeholder="">
                        </div>

                        <div class="form-group col-md-2">
                            <label for="">Suframa</label>
                            <input type="text" class="form-control" name="suframa" id="" aria-describedby="helpId" placeholder="">
                        </div>
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <input type="text" class="form-control" name="lote" id="" aria-describedby="helpId" placeholder="">
                        </div>
        ...
        <script>
 function Valores(){
    document.getElementById('promocao').value = document.getElementById('venda').value;
    document.getElementById('prazo').value = document.getElementById('venda').value;
