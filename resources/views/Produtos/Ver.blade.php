            ...
            <div id="Dados" class="tab-pane active .container-fluid">
                ...
                <div Style='margin-left:1%;margin-right:1%;' class='form-row'>
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <input required type="text" onclick="Valores();" value="{{$produto->ValorUnitario}}" class="form-control" name="ValorUnitario" id="venda" aria-describedby="helpId" placeholder="">
                    </div>

                    <div class="form-group col-md-2">
                        <label for="">Preço Promoção</label>
                        <input type="text" value="{{$produto->ValorPromocao}}" class="form-control" name="promocao" id="promocao" aria-describedby="helpId" placeholder="">
                    </div>

                    <div class="form-group col-md-2">
                        <label for="">Preço a Prazo</label>
                        <input type="text" value="{{$produto->ValorPrazo}}" class="form-control" name="prazo" id="prazo" aria-describedby="helpId" placeholder="">
                    </div>

                    <div class="form-group col-md-2">
                        <label for="">Preço de Custo</label>
                        <input type="text" value="{{$produto->Custo}}" class="form-control" name="custo" id="custo" aria-describedby="helpId" placeholder="">
                    </div>
