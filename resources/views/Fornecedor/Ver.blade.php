...
<h5 Style='margin-left:1%;margin-right:1%;'class="text-left">Editar de Fornecedor</h5>
            ...
            <div id="Dados Pessoais" class="tab-pane active .container-fluid">
                ...
                <div Style='margin-left:1%;margin-right:1%;' class='form-row'>
                    ...
                    <div class="form-group col-md-2">
                        <label for="">CPF</label>
                        <input  type="number" value="{{$Fornecedors->Cpf}}" class="form-control" name="CPF" id="" aria-describedby="helpId" placeholder="">
                    </div>

                    <div class="form-group col-md-2">
                        <label for="">RG</label>
                        <input type="number" value="{{$Fornecedors->Rg}}" class="form-control" name="RG" id="" aria-describedby="helpId" placeholder="">
                    </div>
